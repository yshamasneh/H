...
const styles = StyleSheet.create({
  ...
  searchIcon: { color: customerTheme.colors.text, fontSize: 24, marginEnd: 8 },
  ...
  restaurantName: { color: customerTheme.colors.text, flex: 1, fontSize: 18, fontWeight: "900", marginEnd: 10 },
  ...
  menuHeroArt: { alignItems: "center", backgroundColor: "#FFF1E8", borderColor: "#FFFFFF", borderRadius: 78, borderWidth: 7, height: 156, justifyContent: "center", position: "absolute", end: "27%", top: 27, transform: [{ rotate: "-6deg" }], width: 156 },
  menuHeroEmoji: { fontSize: 72 },
  heroHeart: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.16)", borderRadius: 22, height: 44, justifyContent: "center", position: "absolute", end: 18, top: 18, width: 44 },
  ...
  categoryTab: { backgroundColor: customerTheme.colors.surface, borderColor: customerTheme.colors.border, borderRadius: 999, borderWidth: 1, marginEnd: 9, paddingHorizontal: 16, paddingVertical: 9 },
  ...
  addButton: { alignItems: "center", backgroundColor: customerTheme.colors.primary, borderColor: "#FFFFFF", borderRadius: 18, borderWidth: 3, bottom: -9, height: 38, justifyContent: "center", position: "absolute", end: -6, width: 38 },
  addButtonText: { color: "#FFFFFF", fontSize: 21, fontWeight: "800", marginTop: -2 },
  cartDock: { backgroundColor: "rgba(255,249,245,0.97)", bottom: 0, start: 0, padding: 14, position: "absolute", end: 0 },
  ...
  cartBarText: { color: "#FFFFFF", flex: 1, fontSize: 15, fontWeight: "900", marginStart: 12 },
